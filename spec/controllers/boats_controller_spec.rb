  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved boat as @boat" do
        ...
        post :create, {:boat => { "title" => "invalid value" }}, valid_session
        assigns(:boat).should be_a_new(Boat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested boat" do
        ...
        Boat.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => boat.to_param, :boat => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the boat as @boat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Boat.any_instance.stub(:save).and_return(false)
        put :update, {:id => boat.to_param, :boat => { "title" => "invalid value" }}, valid_session
        assigns(:boat).should eq(boat)
      end
