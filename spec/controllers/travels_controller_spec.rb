  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved travel as @travel" do
        ...
        post :create, {:travel => { "trip_id" => "invalid value" }}, valid_session
        assigns(:travel).should be_a_new(Travel)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested travel" do
        ...
        Travel.any_instance.should_receive(:update).with({ "trip_id" => "1" })
        put :update, {:id => travel.to_param, :travel => { "trip_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the travel as @travel" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Travel.any_instance.stub(:save).and_return(false)
        put :update, {:id => travel.to_param, :travel => { "trip_id" => "invalid value" }}, valid_session
        assigns(:travel).should eq(travel)
      end
